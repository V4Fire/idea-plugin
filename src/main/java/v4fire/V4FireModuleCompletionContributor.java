...
public class V4FireModuleCompletionContributor extends CompletionContributor {
    private static final Logger log = Logger.getInstance(V4FireModuleCompletionContributor.class);

    public V4FireModuleCompletionContributor() {
